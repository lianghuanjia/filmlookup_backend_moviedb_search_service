...
/**
 * This is the entity that represents movie table
 */
@Entity
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
// With Builder, you can easily handle optional fields without creating numerous constructors. You only set the fields that are relevant for a particular object creation.
@Table(name = "movie")
public class Movie {
    ...
    @ManyToMany
    // One Movie can have multiple Genres, and one Genre can have multiple Movies. So many-to-many relationship
